 ...
 * @hidden
 */
var defaultMessenger = /*#__PURE__*/new avalancheJsNetwork.Messenger( /*#__PURE__*/new avalancheJsNetwork.HttpProvider('http://localhost:9500'), avalancheJsUtils.ChainType.Avalanche, avalancheJsUtils.ChainID.HmyLocal);
...
var Account = /*#__PURE__*/function () {
  ...
  function Account(key, messenger) {
    ...
    this.shards.set(this.shardID, {
      address: "" + this.bech32Address + avalancheJsUtils.AddressSuffix + "0",
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              if (!(this.privateKey && avalancheJsUtils.isPrivateKey(this.privateKey))) {
                _context.next = 9;
                break;
              }

              _context.next = 3;
              return avalancheJsCrypto.encrypt(this.privateKey, password, options);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 3:
              ...
              _context2.next = 6;
              return avalancheJsCrypto.decrypt(file, password);

            case 6:
              decyptedPrivateKey = _context2.sent;

              if (!avalancheJsUtils.isPrivateKey(decyptedPrivateKey)) {
                _context2.next = 11;
                break;
              }
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBalance, [this.address, blockNumber], this.messenger.chainPrefix, this.messenger.currentShard || 0);

            case 5:
              balance = _context3.sent;
              _context3.next = 8;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionCount, [this.address, blockNumber], this.messenger.chainPrefix, this.messenger.currentShard || 0);
            ...
            case 13:
              this.balance = avalancheJsUtils.hexToNumber(balance.result);
              this.nonce = Number.parseInt(avalancheJsUtils.hexToNumber(nonce.result), 10);
              this.shardID = this.messenger.currentShard || 0;
              _context3.next = 19;
              break;
          ...
          switch (_context5.prev = _context5.next) {
            ...
            case 9:
              ...
              transaction.setParams(_extends({}, transaction.txParams, {
                from: this.messenger.chainPrefix === avalancheJsUtils.ChainType.Avalanche ? this.bech32Address : this.checksumAddress || '0x',
                nonce: shardNonce
              }));
            ...
            case 11:
              ...
              _RLPSign = avalancheJsTransaction.RLPSign(transaction, this.privateKey), signature = _RLPSign[0], rawTransaction = _RLPSign[1];
              return _context5.abrupt("return", transaction.map(function (obj) {
                return _extends({}, obj, {
                  signature: signature,
                  rawTransaction: rawTransaction,
                  from: _this.messenger.chainPrefix === avalancheJsUtils.ChainType.Avalanche ? _this.bech32Address : _this.checksumAddress || '0x'
                });
              }));
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 10:
              ...
              staking.setFromAddress(this.messenger.chainPrefix === avalancheJsUtils.ChainType.Avalanche ? this.bech32Address : this.checksumAddress || '0x');
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetBalance, [this.address, blockNumber], this.messenger.chainPrefix, shardID);

            case 3:
              balance = _context7.sent;
              _context7.next = 6;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetTransactionCount, [this.address, blockNumber], this.messenger.chainPrefix, shardID);
            ...
            case 11:
              return _context7.abrupt("return", {
                address: "" + this.bech32Address + avalancheJsUtils.AddressSuffix + shardID,
                balance: avalancheJsUtils.hexToNumber(balance.result),
                nonce: Number.parseInt(avalancheJsUtils.hexToNumber(nonce.result), 10)
              });
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              _context8.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetAccountNonce, [this.address, blockNumber], this.messenger.chainPrefix, shardID);
  ...
  _proto._new = function _new() {
    var prv = avalancheJsCrypto.generatePrivateKey();

    if (!avalancheJsUtils.isPrivateKey(prv)) {
  ...
  _proto._import = function _import(key) {
    if (!avalancheJsUtils.isPrivateKey(key)) {
      throw new Error(key + " is not PrivateKey");
    }

    this.privateKey = avalancheJsUtils.add0xToString(key);
    this.publicKey = avalancheJsCrypto.getPubkeyFromPrivateKey(this.privateKey);
    this.address = avalancheJsCrypto.getAddressFromPrivateKey(this.privateKey);
    this.shardID = this.messenger.currentShard || 0;
    this.shards = new Map();
    this.shards.set(this.shardID, {
      address: "" + this.bech32Address + avalancheJsUtils.AddressSuffix + "0",
  ...
  _createClass(Account, [{
    key: "checksumAddress",
    get: function get() {
      return this.address ? avalancheJsCrypto.getAddress(this.address).checksum : '';
    }
    /**
     * Get bech32 Address
     *
    ...
    key: "bech32Address",
    get: function get() {
      return this.address ? avalancheJsCrypto.getAddress(this.address).bech32 : '';
    }
    /**
    ...
    get: function get() {
      return this.address ? avalancheJsCrypto.getAddress(this.address).bech32TestNet : '';
    }
    /**
...
var Wallet = /*#__PURE__*/function () {
  ...
  Wallet.generateMnemonic = function generateMnemonic() {
    return avalancheJsCrypto.bip39.generateMnemonic();
  }
  /**
  ...
  _proto.addByMnemonic = function addByMnemonic(phrase, index) {
    ...
    var seed = avalancheJsCrypto.bip39.mnemonicToSeed(phrase);
    var hdKey = avalancheJsCrypto.hdkey.fromMasterSeed(seed); // TODO:hdkey should apply to Avalanche's settings

    var path = this.messenger.chainType === avalancheJsUtils.ChainType.Avalanche ? '1023' : '60';
    ...
    var _createAccount = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(password, options) {
      ...
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              prv = avalancheJsCrypto.generatePrivateKey();
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              if (!(foundAcc && foundAcc.privateKey && avalancheJsUtils.isPrivateKey(foundAcc.privateKey))) {
                _context3.next = 8;
                break;
              }
  ...
  _proto.getAccount = function getAccount(address) {
    return this.accountMap.get(avalancheJsCrypto.getAddress(address).basicHex);
  }
  /**
  ...
  _proto.removeAccount = function removeAccount(address) {
    this.accountMap["delete"](avalancheJsCrypto.getAddress(address).basicHex);
  ...
  _proto.setSigner = function setSigner(address) {
    if (!avalancheJsUtils.isAddress(address) && !this.getAccount(address)) {
  ...
  _proto.isValidMnemonic = function isValidMnemonic(phrase) {
    ...
    return avalancheJsCrypto.bip39.validateMnemonic(phrase);
  };
...
var HDNode = /*#__PURE__*/function () {
  function HDNode(provider, menmonic, index, addressCount, shardID, chainType, chainId, gasLimit, gasPrice) {
    ...
    if (chainType === void 0) {
      chainType = avalancheJsUtils.ChainType.Avalanche;
    }

    if (chainId === void 0) {
      chainId = avalancheJsUtils.ChainID.Default;
    }
    ...
    this.messenger = new avalancheJsNetwork.Messenger(this.provider, chainType, chainId);
    this.messenger.setDefaultShardID(this.shardID);
    this.hdwallet = undefined;
    this.addresses = [];
    this.wallets = {};
    this.path = chainType === avalancheJsUtils.ChainType.Avalanche ? avalancheJsUtils.HDPath : "m/44'/60'/0'/0/";
    this.index = index;
  ...
  _proto.setProvider = function setProvider(provider) {
    if (avalancheJsUtils.isHttp(provider) && typeof provider === 'string') {
      return new avalancheJsNetwork.HttpProvider(provider);
    } else if (provider instanceof avalancheJsNetwork.HttpProvider) {
      return provider;
    } else if (avalancheJsUtils.isWs(provider) && typeof provider === 'string') {
      return new avalancheJsNetwork.WSProvider(provider);
    } else if (provider instanceof avalancheJsNetwork.WSProvider) {
      return provider;
    } else {
  ...
  _proto.getHdWallet = function getHdWallet(mnemonic) {
    ...
    this.hdwallet = avalancheJsCrypto.hdkey.fromMasterSeed(avalancheJsCrypto.bip39.mnemonicToSeed(mnemonic));
    ...
    var _signTransaction = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(txParams) {
      ...
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              from = txParams.from ? avalancheJsCrypto.getAddress(txParams.from).checksum : '0x';
              _context.next = 3;
              return this.messenger.send(avalancheJsNetwork.RPCMethod.GetAccountNonce, [from, 'latest'], 'hmy', this.shardID);

            case 3:
              accountNonce = _context.sent;
              to = txParams.to ? avalancheJsCrypto.getAddress(txParams.to).checksum : '0x';
              gasLimit = new avalancheJsUtils.Unit('0').asWei().toWei();

              if (txParams.gas !== undefined && avalancheJsUtils.isHex(txParams.gas)) {
                gasLimit = new avalancheJsUtils.Unit(txParams.gas).asWei().toWei().lt(new avalancheJsUtils.Unit(this.gasLimit).asWei().toWei()) ? new avalancheJsUtils.Unit(txParams.gas).asWei().toWei() : new avalancheJsUtils.Unit(this.gasLimit).asWei().toWei();
              }

              if (txParams.gasLimit !== undefined && avalancheJsUtils.isHex(txParams.gasLimit)) {
                gasLimit = new avalancheJsUtils.Unit(txParams.gasLimit).asWei().toWei().lt(new avalancheJsUtils.Unit(this.gasLimit).asWei().toWei()) ? new avalancheJsUtils.Unit(txParams.gasLimit).asWei().toWei() : new avalancheJsUtils.Unit(this.gasLimit).asWei().toWei();
              }

              gasPrice = new avalancheJsUtils.Unit('0').asWei().toWei();

              if (txParams.gasPrice !== undefined && avalancheJsUtils.isHex(txParams.gasPrice)) {
                gasPrice = new avalancheJsUtils.Unit(txParams.gasPrice).asWei().toWei().lt(new avalancheJsUtils.Unit(this.gasPrice).asWei().toWei()) ? new avalancheJsUtils.Unit(txParams.gasPrice).asWei().toWei() : new avalancheJsUtils.Unit(this.gasPrice).asWei().toWei();
              }

              value = txParams.value !== undefined && avalancheJsUtils.isHex(txParams.value) ? txParams.value : '0';
              nonce = txParams.nonce !== undefined && avalancheJsUtils.isHex(txParams.nonce) ? Number.parseInt(avalancheJsUtils.hexToNumber(txParams.nonce), 10) : accountNonce.result;
              data = txParams.data !== undefined && avalancheJsUtils.isHex(txParams.data) ? txParams.data : '0x';
              prv = this.wallets[from].privateKey;
              signerAccount = new Account(prv, this.messenger);
              tx = new avalancheJsTransaction.Transaction(_extends({}, txParams, {
                from: from,
                to: to,
                gasLimit: gasLimit,
                gasPrice: gasPrice,
              ...
              }), this.messenger, avalancheJsTransaction.TxStatus.INTIALIZED);
              _context.next = 18;
...
//# sourceMappingURL=avalanche-js-account.cjs.development.js.map
